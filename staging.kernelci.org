...
"
    ...
    frag_arg="--fragment=kernelci"
    args="build --push $px_arg"
    ./kci_docker $args kernelci $rev_arg
    ./kci_docker $args k8s $rev_arg $frag_arg
    for clang in clang-11 clang-15; do
	./kci_docker $args $clang $frag_arg
    done
    for arch in arc arm armv5 arm64 mips riscv64 x86 sparc; do
	./kci_docker $args gcc-10 --arch $arch $frag_arg
    done
    cd -
}
